    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width:180px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
           ...
           <li>
         		<span>图表统计</span>
         		<ul>
	         		<li><a href="${pageContext.request.contextPath}/chart/BBSCategoryChart.action">按模块统计</a></li>
	         		<li><a href="${pageContext.request.contextPath}/chart/BBSYearCategoryChart.action">按年份统计</a></li>
	         	</ul>
         	</li>
         	 <li>
         		<span>用户数据导出</span>
         		<ul>
	         		<li><a href="${pageContext.request.contextPath}/export/exportExcel.action">用户信息导出</a></li>
	         	</ul>
         	</li>
         </ul>
    </div>
